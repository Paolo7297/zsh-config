...
() {
  ...
  typeset -g __p9k_instant_prompt_param_sig=$'\'\'\C-A5.9\C-Azsh-5.9-0-g73d3173\C-A\C-AWezTerm\C-A1\C-Apaolo%\C-A\C-A\C-A\C-A\C-A\C-A\C-A1\C-A0\C-A0\C-A\C-A%B%S%#%s%b\C-A1\C-AUTF-8\C-A\C-A\C-A0\C-A1\C-A/home/paolo/.zsh2/.zgenom/sources/romkatv/powerlevel10k/___\C-A\C-A\C-A\C-A\C-A1\C-A256\C-A0\C-A/home/paolo/.p10k.zsh'
  local gitstatus_dir=/home/paolo/.zsh2/.zgenom/sources/romkatv/powerlevel10k/___/gitstatus
  ...
  local cr=$'\r' lf=$'\n' esc=$'\e[' rs=$'\x1e' us=$'\x1f'
  local -i height=1
  local prompt_dir=/home/paolo/.cache/p10k-paolo
